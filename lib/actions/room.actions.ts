...
export const getDocument = async ({
  ...
  try {
    ...
    console.log(`Error while getting a room: ${error}`);
  }
};
...
export const updateDocumentAccess = async ({
  ...
  try {
    ...
    console.log(`Error while updating a room access: ${error}`);
  }
};
...
export const removeDocumentAccess = async ({
  ...
  try {
    ...
    console.log(`Error while removing a room access: ${error}`);
  }
};
...
export const deleteDocument = async (roomId: string) => {
  try {
    ...
    console.log(`Error while deleting a room: ${error}`);
  }
};
